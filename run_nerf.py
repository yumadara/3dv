...
from colmapUtils.read_write_model import write_points3d_binary

import matplotlib.pyplot as plt

from run_nerf_helpers import *

from load_llff import load_llff_data, load_colmap_depth, refine_points_to_masked
...
def train():
    ...
    if args.dataset_type == 'llff':
        if args.colmap_depth:
            #TODO here
            out_p = refine_points_to_masked(args.datadir, factor=args.factor, bd_factor=.75)
            write_points3d_binary(out_p, args.datadir+"/sparse/0/points3D_new.bin")
